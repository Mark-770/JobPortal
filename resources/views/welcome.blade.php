            ...
            <div class="row">
                <div class="col-md-12 mb-5 mb-md-0" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="rounded border jobs-wrap">
                        @foreach($jobs as $job)
                            <a href="{{ route('jobs.show',[$job->id , $job->slug]) }}" class="job-item d-block d-md-flex align-items-center
                        border-bottom
                                ...
                                <div class="job-details h-100">
                                    <div class="p-3 align-self-center">
                                        ...
                                        <div class="d-block d-lg-flex">
                                            <div class="mr-3"><span
                                                    class="icon-suitcase mr-1"></span> {{str_limit($job->company->cname,20)}}
                                            </div>
                                            <div class="mr-3"><span
            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-md-6 text-center" data-aos="fade">
                    ...
                    <p><a href="/register" class="btn btn-outline-success py-3 px-4">Job Seeker</a> <a
                            href="{{route('employer.register')}}" class="btn btn-outline-warning py-3 px-4">Employer</a>
                    </p>
